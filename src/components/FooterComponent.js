        ...
        return (
            <footer className="darkTh">
                ...
                <div className="container">
                    ...
                    Подарок скидка предоставляется на последующую покупку от 1000* рублей в супермаркете «Виктория» 
                    {this.props.region === 'Калининград, Россия' && '(для магазинов «Виктория Квартал» и «Дешево» сумма покупки составляет от 700р)'}
                    и рассчитывается от цены, действующей в магазине на момент покупки.  Для участия в розыгрыше необходимо зарегистрироваться на сайте 
                    <a href="https://dixy.ru/" terget="_blank">www.dixy.ru</a>.
<br />
